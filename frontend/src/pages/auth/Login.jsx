...
export default function Login() {
  ...
  const handleGoogle = () => {
    window.location.href = `${import.meta.env.VITE_API_URL?.replace('/api','') || ''}/api/auth/google?role=${role}`;
  };
    ...
    <div className="hl-auth-root">
      ...
      <div className="hl-auth-right">
        <div className={`hl-auth-card${mounted ? ' hl-visible' : ''}`}>
          ...
          {/* Google */}
          <button type="button" className="hl-google-btn" onClick={handleGoogle}>
